    ...
    >
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Link href={siteSettings.headerSecondButtonUrl[locale]} sx={{variant: 'buttons.naExtraSmall'}}>
          ...
          <Link href={siteSettings.headerButtonUrl[locale]} sx={{variant: 'buttons.blueMedium'}}>
        ...
        <Box sx={{
          ...
          width: [isOpen ? '100vw' : '0', null, null, null, '100vw'],
          padding: [isOpen ? '10px' : '0', null, null, null, '0'],
          overflow: 'hidden',
          transform: [!isOpen ? 'translate3d(100%, 0, 0)' : 'translate3d(0, 0, 0);', null, null, null, 'none'],
          transition: isOpen ? 'transform 0.3s, width 0s 0s' : 'transform 0.3s, width 0s 0.3s',
