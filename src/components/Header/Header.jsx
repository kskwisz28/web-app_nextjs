...
export default function Header({
  ...
  const {locale: currentLanguage, asPath} = useRouter()
  ...
  const menuItems = useMemo(() => navMenu.menuItems[currentLanguage], [navMenu, currentLanguage])
  return (
    <Box
      sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{backgroundColor: 'white', p: '10px'}}>
            <NextLink href="/" passHref legacyBehavior>
              <Link variant="blue">
                Start now <svg sx={{ml: '12px'}} width="15" height="13" viewBox="0 0 15 13" fill="none"
