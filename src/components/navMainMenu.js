...
function IconUser(props) {
  return (
    <svg width="21" height="24" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12.75 14.25H8.25C3.65625 14.25 0 17.9531 0 22.5C0 23.3438 0.65625 24 1.5 24H19.5C20.2969 24 21 23.3438 21 22.5C21 17.9531 17.2969 14.25 12.75 14.25ZM2.25 21.75C2.625 18.7969 5.15625 16.5 8.25 16.5H12.75C15.7969 16.5 18.3281 18.7969 18.7031 21.75H2.25ZM10.5 12C13.7812 12 16.5 9.32812 16.5 6C16.5 2.71875 13.7812 0 10.5 0C7.17188 0 4.5 2.71875 4.5 6C4.5 9.32812 7.17188 12 10.5 12ZM10.5 2.25C12.5625 2.25 14.25 3.9375 14.25 6C14.25 8.10938 12.5625 9.75 10.5 9.75C8.39062 9.75 6.75 8.10938 6.75 6C6.75 3.9375 8.39062 2.25 10.5 2.25Z" fill={props.color} />
    </svg>
  )
}
        ...
        <Flex css={{ alignItems: 'center' }}>
          ...
          <Link
            ...
            href={
              ...
              props.siteSettings.headerButtonUrl.translate
            }
          >
            <Button py={2} variant="buttons.kiwi">
              {props.siteSettings &&
                props.siteSettings.headerButtonText &&
                props.siteSettings.headerButtonText.translate}
            </Button>
          </Link>

          <a href={props?.siteSettings?.headerSecondButtonUrl?.translate}>
