        ...
        >
          ...
          >
            <AnimatedSwitch
              ...
              activated={search}
              titleBefore="Sökfunktion"
            />
          </motion.div>
          <Box my={1} px={2} css={{ display: 'block', minWidth: '200px' }}>
            <AnimatedSwitch onClick={changeWishlist} titleBefore="Önskelista" />
          </Box>
          ...
          <Box my={1} px={2} css={{ display: 'block', minWidth: '200px' }}>
            <AnimatedSwitch onClick={changeBanner} titleBefore="Banners" />
          </Box>
          <Box my={1} px={2} css={{ display: 'block', minWidth: '200px' }}>
            <AnimatedSwitch onClick={changeChat} titleBefore="Chat" />
          </Box>
          <Box px={2} css={{ display: 'none' }}>
            <AnimatedSwitch
